...
<head>
	...
	<title>WatchDog Online 항목 이상 조회</title>
...
<body>
        ...
        <div class="row">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse show" id="submenu2-2" aria-expanded="true">
                                            <ul class="flex-column pl-4 nav">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active py-1" href="/online/itemresult"> 
            ...
            <main role="main" class="col-md-10 ml-sm-auto col-lg-10 px-4">
	            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
	                ...
	                <h1 class="h2">WatchDog Online 항목 이상 확률</h1>
	            ...
	            <table id="resultitemprobtable" data-toggle="resultitemprobtable"
    ...
    <script type="text/javascript">
	        ...
	        $.ajax({
	            ...
	            success : function(projectNameList) {
	                ...
	                $("#projectNameItemDropdownMenu a").click(function(){
	                    ...
	                    fn_setRegdtimDropdown("<c:url value='/online/itemresult/" + projectName + "/regdtim/' />", $('#regdtimDropdown'))
	                });
	            },
	    ...
	    var fn_setRegdtimDropdown = function(url, target) {
	        $.ajax({
	            ...
	            success : function(regdtimList) {
	            	...
	            	var allRegdtim = '<a class="dropdown-item" href="#">'+'All'+'</a>';
	            	$(allRegdtim).appendTo('#regdtimDropdownMenu');
	                $.each(listName, function(index) {
	                ...
	                $("#regdtimDropdownMenu a").click(function(){
	                    ...
	                    $table.bootstrapTable('refreshOptions', {
	                        url: '/online/itemresult/'+projectName+'/'+regdtim,
	                        onLoadError: function(status){
	                        	alert("[STATUS "+status+"]"+"항목 분포 변화 조회에 실패했습니다");
	                        }
	                    })
	                    fn_setFieldNameDropdown("<c:url value='/online/itemresult/" + projectName + "/" + regdtim +"/fieldname/' />");
	                });
	            },
	            error : function(request, status, error) {
					alert('code:'+request.status+'\n'+'message:'+request.responseText+'\n'+'error:'+error);
			...
			$.ajax({
				...
				success : function(fieldList) {
				    ...
				    $('#fieldNameDropdownMenu a').click(function(){
						...
						$table.bootstrapTable('refreshOptions', {
							url: '/online/itemresult/'+projectName+'/'+regdtim+'/'+fieldName,
							onLoadError: function(status){
	                        	alert("[STATUS "+status+"]"+"항목 분포 변화 조회에 실패했습니다");
	                        }
						})
	    ...
	    $(document).ready(function() {
	        fn_setprojectNameItemDropdown("<c:url value='/online/itemresult/projectnames' />", $('projectNameItemDropdown'));
	        initTable();
	    });
	</script>
</body>
