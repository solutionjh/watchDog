...
<head>
	...
	<meta name="description" content="WatchDog 항목 이상 조회 화면" />
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse show" id="submenu2-2" aria-expanded="true">
                                            <ul class="flex-column pl-4 nav">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active py-1" href="/online/rowresult">
            ...
            <main role="main" class="col-md-10 ml-sm-auto col-lg-10 px-4">
	            ...
	            <table id="rowresulttable" data-toggle="rowresulttable"
    ...
    <script type="text/javascript">
	        ...
	        $.ajax({
	            ...
	            success : function(projectNameList) {
	                ...
	                $("#projectNameDropdownMenu a").click(function(){
	                    ...
	                    fn_setRegdtimDropdown("<c:url value='/online/rowresult/" + projectName + "/regdtim/' />", $('#regdtimDropdown'))
	                    $table.bootstrapTable('refreshOptions', {
	                        url: '/online/rowresult/'+projectName+'/',
	                        onLoadError: function(status){
	                        	alert("[STATUS "+status+"]"+"파일 이상 확률 죄회에 실패했습니다");
	                        }
	                    })
	                });
	            },
	        ...
	        $.ajax({
	            ...
	            success : function(regdtimList) {
	                ...
	                $("#regdtimDropdownMenu a").click(function(){
	                    ...
	                    $table.bootstrapTable('refreshOptions', {
	                        url: '/online/rowresult/'+projectName+'/'+regdtim,
	                        onLoadError: function(status){
	                        	alert("[STATUS "+status+"]"+"항목 이상 결과 조회에 실패했습니다");
	                        }
	                    })
	                });
	            },
	    ...
	    $(document).ready(function() {
	        fn_setprojectNameDropdown("<c:url value='/online/rowresult/projectnames' />", $('projectNameDropdown'));
	        initTable();
	    });
	</script>
</body>
