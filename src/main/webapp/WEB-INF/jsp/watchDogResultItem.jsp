...
<body>
        ...
        <div class="row">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse show" id="submenu1-2" aria-expanded="false">
                                            <ul class="flex-column pl-4 nav">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active py-1" href="/resultitem"> 
            ...
            <main role="main" class="col-md-10 ml-sm-auto col-lg-10 px-4">
	            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
	                ...
	                <h1 class="h2">WatchDog 항목 이상 결과</h1>
	            ...
	            <table id="resultitemtable" data-toggle="resultitemtable"
    ...
    <script type="text/javascript">
	        ...
	        $.ajax({
	            ...
	            success : function(projectNameList) {
	                ...
	                $("#projectNameItemDropdownMenu a").click(function(){
	                    ...
	                    fn_setRegdtimDropdown("<c:url value='/resultitem/" + projectName + "/regdtim/' />", $('#regdtimDropdown'))
	                });
	            },
	    ...
	    $(document).ready(function() {
	        fn_setprojectNameItemDropdown("<c:url value='/result/projectnames' />", $('projectNameItemDropdown'));
	        initTable();
	    });
	</script>
</body>
