...
<head>
	...
	<meta name="description" content="WatchDog Online 결과 조회 화면" />
	
	<title>WatchDog Online 결과 조회</title>
...
<body>
        ...
        <div class="row">
                                ...
                                <ul class="flex-column pl-4 nav">
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse show" id="submenu2-2" aria-expanded="true">
                                            <ul class="flex-column pl-4 nav">
                                                <li class="nav-item">
                                                    <a class="nav-link active py-1" href="/online/result">
            ...
            <main role="main" class="col-md-10 ml-sm-auto col-lg-10 px-4">
	            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
	                ...
	                <h1 class="h2">WatchDog Online 수행 결과</h1>
	            ...
	            <table id="resulttable" data-toggle="resulttable"
	                data-content-type="application/json" data-url="/online/result/results"
    ...
    <script type="text/javascript">
	    ...
	    $(document).ready(function() {
	        fn_setProjectNameDropdown("<c:url value='/online/result/projectnames' />", $('projectNameDropdown'));
